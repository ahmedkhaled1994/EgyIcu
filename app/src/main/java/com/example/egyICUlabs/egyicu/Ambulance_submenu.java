...
public class Ambulance_submenu extends ActionBarActivity {
Toolbar toolbar;
    int reqCode =0;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ambulance_submenu);
        ...
        SpannableString s = new SpannableString(getString(R.string.ambulance));
        ...
        listview.setAdapter(new ImageAdapter(this, 3));
                    ...
                    case 0:
                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                            if (checkSelfPermission("android.permission.CALL_PHONE") == getPackageManager().PERMISSION_DENIED)
                                ...
                                String uri = getResources().getString(R.string.Ambulance_public); ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_ambulance_submenu, menu);
        return true;
    }
